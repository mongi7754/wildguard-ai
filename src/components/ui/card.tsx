  ...
  "rounded-xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        tactical: "bg-card/80 backdrop-blur-sm border-border/50 shadow-xl",
        glow: "bg-card border-primary/30 shadow-[0_0_20px_hsl(var(--primary)/0.15)]",
        alert: "bg-card border-accent/50 shadow-[0_0_20px_hsl(var(--accent)/0.2)]",
        danger: "bg-card border-danger/50 shadow-[0_0_20px_hsl(var(--danger)/0.2)]",
